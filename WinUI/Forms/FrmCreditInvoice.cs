...
{
    public partial class FrmCreditInvoice : Form
    {
        public FrmCreditInvoice()
        {
            InitializeComponent();
        ...
        public FrmCreditInvoice(DEInvoice inv)
        {
            InitializeComponent();
            rdo_isCarton.Checked = true;
            rdo_Price1.Checked = true;
        ...
        public FrmCreditInvoice(CtrlSale saleTemp)
        {
            InitializeComponent();
            rdo_isCarton.Checked = true;
            rdo_Price1.Checked = true;
        ...
        public FrmCreditInvoice(DEInvoice inv, CtrlSale saleTemp)
        {
            InitializeComponent();
            rdo_isCarton.Checked = true;
            rdo_Price1.Checked = true;
        ...
        private void FrmCreditInvoice_Load(object sender, EventArgs e)
        {
        ...
        private void displayInvoiceData()
        {
            ...
            txt_Advance.Text = invoice.Advance.ToString("##.##");
            txt_CommercialTax.Text = invoice.CommercialTax.ToString("##.##");
            txt_DiscountPercent.Text = invoice.DiscountPercent.ToString("##.##");
            txt_Discount.Text = invoice.Discount.ToString("##.##");
            txt_DDPercent.Text = invoice.DDPercent.ToString("##.##");
            txt_DeliveryDiscount.Text = invoice.DeliveryDiscount.ToString("##.##");
            ...
            if (invoice.isReturn == false)
            {
                ...
                if (Colse_Result == DialogResult.Yes)
                {
                    ...
                    else
                    {
                        ...
                        FrmConsignmentReturn frm_ConsignmentReturn = new FrmConsignmentReturn(invoice,this);
