...
namespace StockAndSale
{
    public partial class FrmCashInvoice : Form
    {
        ...
        public FrmCashInvoice(CtrlSale saleTemp)
        {
            InitializeComponent();
            rdo_isCarton.Checked = true;
            rdo_Price1.Checked = true;
        ...
        public FrmCashInvoice(DEInvoice inv)
        {
            InitializeComponent();
            rdo_isCarton.Checked = true;
            rdo_Price1.Checked = true;
        ...
        public FrmCashInvoice(DEInvoice inv,CtrlSale saleTemp)
        {
            InitializeComponent();
            rdo_isCarton.Checked = true;
            rdo_Price1.Checked = true;
        ...
        private void FrmCashInvoice_Load(object sender, EventArgs e)
        {
        ...
        private Boolean ValidateUserInput()
        {
            ...
            {
                bool_Test = false;
                ErrorProvider.SetError(txt_Invoice_No, "Enter New Invoice");
                string str_error = ErrorProvider.GetError(txt_Invoice_No);
                MessageBox.Show(str_error);
            }
        ...
        private void assignInvoiceData()
        {
            ...
            invoice.Invoice_Due_Date = invoice.Invoice_Date;

            invoice.PayDate = invoice.Invoice_Date;
        ...
        private void dtp_InvoiceDate_Leave(object sender, EventArgs e)
        {
            cbx_Product.Focus();
        }
        ...
        private void txt_Return_TextChanged_1(object sender, EventArgs e)
        {
            calculateTotal(dt_ProductList);
        }
