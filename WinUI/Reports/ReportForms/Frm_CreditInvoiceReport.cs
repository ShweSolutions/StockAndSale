...
{
    public partial class Frm_CreditInvoiceReport : Form
    {
        public Frm_CreditInvoiceReport()
        {
            InitializeComponent();
        ...
        public Frm_CreditInvoiceReport(Guid temp_Invoice_Id)
        {
            InitializeComponent();
        ...
        private void Frm_CreditInvoiceReport_Load(object sender, EventArgs e)
        {
        ...
        private void bindInvoiceReport()
        {
            ...
            rptv_CreditInvoiceReport.Clear();
            rptv_CreditInvoiceReport.Reset();

            rptv_CreditInvoiceReport.ProcessingMode = ProcessingMode.Local;

            LocalReport localReport = rptv_CreditInvoiceReport.LocalReport;

            if(chb_SmallSize.Checked == false)
                localReport.ReportEmbeddedResource = "StockAndSale.WinUI.Reports.Classes.Rpt_CreditInvoiceReport.rdlc";
            else
                localReport.ReportEmbeddedResource = "StockAndSale.WinUI.Reports.Classes.Rpt_CreditInvoiceA5Report.rdlc";
            ...
            rptv_CreditInvoiceReport.RefreshReport();
        }
